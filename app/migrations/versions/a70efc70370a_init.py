...
Revision ID: a70efc70370a
Revises: 
Create Date: 2022-06-23 19:45:31.987070
...
def upgrade():
    ...
    op.create_table('intermediate_books_genres',
    sa.Column('book_id', sa.Integer(), nullable=False),
    sa.Column('genre_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['book_id'], ['books.id'], name=op.f('fk_intermediate_books_genres_book_id_books')),
    sa.ForeignKeyConstraint(['genre_id'], ['genres.id'], name=op.f('fk_intermediate_books_genres_genre_id_genres'))
    )
...
def downgrade():
    ...
    op.drop_table('intermediate_books_genres')
    op.drop_table('users')
    op.drop_table('books')
    op.drop_table('roles')
